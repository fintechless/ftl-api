...
BLUEPRINT_PROVIDER: Blueprint = Blueprint(
    "provider",
    __name__,
    url_prefix="/mgr/provider",
)

BLUEPRINT_PROVIDER.json_encoder = CstmJsonEncoder


@BLUEPRINT_PROVIDER.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_PROVIDER.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_PROVIDER.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_PROVIDER.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_PROVIDER.before_request
