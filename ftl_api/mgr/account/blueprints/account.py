...
BLUEPRINT_ACCOUNT: Blueprint = Blueprint(
    "account",
    __name__,
    url_prefix="/mgr/account",
)

BLUEPRINT_ACCOUNT.json_encoder = CstmJsonEncoder


@BLUEPRINT_ACCOUNT.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_ACCOUNT.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_ACCOUNT.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_ACCOUNT.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_ACCOUNT.before_request
