...
BLUEPRINT_BUILD: Blueprint = Blueprint(
    "build",
    __name__,
    url_prefix="/mgr/build",
)

BLUEPRINT_BUILD.json_encoder = CstmJsonEncoder


@BLUEPRINT_BUILD.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_BUILD.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_BUILD.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_BUILD.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_BUILD.before_request
