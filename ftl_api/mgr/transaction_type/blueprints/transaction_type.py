"""
Flask blueprint for TRANSACTION_TYPE
"""
...
BLUEPRINT_TRANSACTION_TYPE: Blueprint = Blueprint(
    "transaction_type",
    __name__,
    url_prefix="/mgr/transaction/type",
)

BLUEPRINT_TRANSACTION_TYPE.json_encoder = CstmJsonEncoder


@BLUEPRINT_TRANSACTION_TYPE.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_TRANSACTION_TYPE.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_TRANSACTION_TYPE.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_TRANSACTION_TYPE.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_TRANSACTION_TYPE.before_request
