"""
Flask blueprint for TRANSACTION
"""
...
BLUEPRINT_TRANSACTION: Blueprint = Blueprint(
    "transaction",
    __name__,
    url_prefix="/mgr/transaction",
)

BLUEPRINT_TRANSACTION.json_encoder = CstmJsonEncoder


@BLUEPRINT_TRANSACTION.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_TRANSACTION.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_TRANSACTION.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_TRANSACTION.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_TRANSACTION.before_request
