...
BLUEPRINT_CONFIG: Blueprint = Blueprint(
    "config",
    __name__,
    url_prefix="/mgr/config",
)

BLUEPRINT_CONFIG.json_encoder = CstmJsonEncoder


@BLUEPRINT_CONFIG.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_CONFIG.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_CONFIG.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_CONFIG.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_CONFIG.before_request
