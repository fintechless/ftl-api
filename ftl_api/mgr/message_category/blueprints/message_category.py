"""
Flask blueprint for MESSAGE_CATEGORY
"""
...
BLUEPRINT_MESSAGE_CATEGORY: Blueprint = Blueprint(
    "message_category",
    __name__,
    url_prefix="/mgr/message/category",
)

BLUEPRINT_MESSAGE_CATEGORY.json_encoder = CstmJsonEncoder


@BLUEPRINT_MESSAGE_CATEGORY.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MESSAGE_CATEGORY.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MESSAGE_CATEGORY.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MESSAGE_CATEGORY.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MESSAGE_CATEGORY.before_request
