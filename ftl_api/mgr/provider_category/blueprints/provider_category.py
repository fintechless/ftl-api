"""
Flask blueprint for PROVIDER_CATEGORY
"""
...
BLUEPRINT_PROVIDER_CATEGORY: Blueprint = Blueprint(
    "provider_category",
    __name__,
    url_prefix="/mgr/provider/category",
)

BLUEPRINT_PROVIDER_CATEGORY.json_encoder = CstmJsonEncoder


@BLUEPRINT_PROVIDER_CATEGORY.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_PROVIDER_CATEGORY.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_PROVIDER_CATEGORY.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_PROVIDER_CATEGORY.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_PROVIDER_CATEGORY.before_request
