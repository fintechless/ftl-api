"""
Flask blueprint for MESSAGE_DEFINITION
"""
...
BLUEPRINT_MESSAGE_DEFINITION: Blueprint = Blueprint(
    "message_definition",
    __name__,
    url_prefix="/mgr/message/definition",
)

BLUEPRINT_MESSAGE_DEFINITION.json_encoder = CstmJsonEncoder


@BLUEPRINT_MESSAGE_DEFINITION.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MESSAGE_DEFINITION.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MESSAGE_DEFINITION.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MESSAGE_DEFINITION.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MESSAGE_DEFINITION.before_request
