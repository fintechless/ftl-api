...
BLUEPRINT_MESSAGE: Blueprint = Blueprint(
    "message",
    __name__,
    url_prefix="/mgr/message",
)

BLUEPRINT_MESSAGE.json_encoder = CstmJsonEncoder


@BLUEPRINT_MESSAGE.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MESSAGE.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MESSAGE.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MESSAGE.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MESSAGE.before_request
