...
BLUEPRINT_MEMBER: Blueprint = Blueprint(
    "member",
    __name__,
    url_prefix="/mgr/member",
)

BLUEPRINT_MEMBER.json_encoder = CstmJsonEncoder


@BLUEPRINT_MEMBER.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MEMBER.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MEMBER.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MEMBER.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MEMBER.before_request
