"""
Flask blueprint for PROVIDER_SUBCATEGORY
"""
...
BLUEPRINT_PROVIDER_SUBCATEGORY: Blueprint = Blueprint(
    "provider_subcategory",
    __name__,
    url_prefix="/mgr/provider/subcategory",
)

BLUEPRINT_PROVIDER_SUBCATEGORY.json_encoder = CstmJsonEncoder


@BLUEPRINT_PROVIDER_SUBCATEGORY.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_PROVIDER_SUBCATEGORY.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_PROVIDER_SUBCATEGORY.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_PROVIDER_SUBCATEGORY.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_PROVIDER_SUBCATEGORY.before_request
