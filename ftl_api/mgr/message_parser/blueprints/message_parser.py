"""
Flask blueprint for MESSAGE_PARSER
"""
...
BLUEPRINT_MESSAGE_PARSER: Blueprint = Blueprint(
    "message_parser",
    __name__,
    url_prefix="/mgr/message/parser",
)

BLUEPRINT_MESSAGE_PARSER.json_encoder = CstmJsonEncoder


@BLUEPRINT_MESSAGE_PARSER.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MESSAGE_PARSER.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MESSAGE_PARSER.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MESSAGE_PARSER.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MESSAGE_PARSER.before_request
