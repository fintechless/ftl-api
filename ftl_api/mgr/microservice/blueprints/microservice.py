"""
Flask blueprint for MICROSERVICE
"""
...
BLUEPRINT_MICROSERVICE: Blueprint = Blueprint(
    "microservice",
    __name__,
    url_prefix="/mgr/microservice",
)

BLUEPRINT_MICROSERVICE.json_encoder = CstmJsonEncoder


@BLUEPRINT_MICROSERVICE.errorhandler(ExceptionInvalidRequest)
...
@BLUEPRINT_MICROSERVICE.errorhandler(ExceptionResourceNotFound)
...
@BLUEPRINT_MICROSERVICE.errorhandler(ExceptionContainerMisconfigured)
...
@BLUEPRINT_MICROSERVICE.errorhandler(ExceptionUnexpectedError)
...
@BLUEPRINT_MICROSERVICE.before_request
