src = {
  ...
  config_key_parent_api = "terraform/fintechless/ftl-api/aws_api_gateway_mgr_provider/terraform.tfstate"
  ...
  config_key_tg         = "terraform/fintechless/ftl-api/aws_lb_target_group_mgr_provider_subcategory/terraform.tfstate"
  ...
  uri_prefix           = "mgr"
  uri_path             = "provider/subcategory"
  resource_path        = "subcategory"
  http_methods = [
    {
      http_method             = "GET"
