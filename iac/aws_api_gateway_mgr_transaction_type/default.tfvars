src = {
  ...
  config_key_parent_api = "terraform/fintechless/ftl-api/aws_api_gateway_mgr_transaction/terraform.tfstate"
  ...
  config_key_tg         = "terraform/fintechless/ftl-api/aws_lb_target_group_mgr_transaction_type/terraform.tfstate"
